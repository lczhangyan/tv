<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\AppServ\www\tv\public/../application/ad\view\launcher\edit.html";i:1527559934;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" style="width: 95%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="apk_value" lay-verify="required" value="<?php echo $result['apk_value']; ?>" autocomplete="off" placeholder="请输入标题" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-row layui-col-space15" id="durImg" style="text-align: center;">
        <img src="<?php echo $result['image_url']; ?>" style="width: 22%;margin: 0 auto">
    </div>
